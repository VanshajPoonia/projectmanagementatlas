    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // A dialog taller than the screen has to scroll, or its last control is unreachable.
          // dvh, not vh: on iOS Safari vh is the height with the URL bar hidden, so a
          // vh-sized dialog is taller than the visible page whenever the bar is showing.
