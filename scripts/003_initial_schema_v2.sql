...
DROP POLICY IF EXISTS "Only admins can insert allowed emails" ON public.allowed_emails;
DROP POLICY IF EXISTS "Only admins can update allowed emails" ON public.allowed_emails;
DROP POLICY IF EXISTS "Only admins can delete allowed emails" ON public.allowed_emails;
...
DROP POLICY IF EXISTS "Only admins can create columns" ON public.columns;
DROP POLICY IF EXISTS "Only admins can update columns" ON public.columns;
DROP POLICY IF EXISTS "Only admins can delete columns" ON public.columns;
